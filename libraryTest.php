...
class PHPAssessmentTests extends PHPUnit_Framework_TestCase
{
    ...
    public function test_find()
    {
        ...
        $this->assertEquals(
            2, find([1, 2, 3],'2'),
            "Expected first([1, 2, 3]) to return 2."
        );

        $this->assertEquals(
            'g', find('Programming','last'),
            "Expected first(Programming) to return 'g'."
        );

        $this->assertEquals(
            'last', find([1,'2',56,'not','last'],'last'),
            "Expected first(Programming) to return 'last'."
        );

        $this->assertEquals(
            5, find([1,'2',56,'not','last',5],'last'),
            "Expected first(Programming) to return 5."
        );
